...
In this short analysis, I included: 
- a table showing
   > the number of patients who had and did not have a cardiac event
   > the proportion of smokers within each subcohort
   > the proportion of female within each subcohort
   > the average age of each subcohort
