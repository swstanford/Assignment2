...
#Multivariable regression of cardiac event against smoking status, female sex, and age 
#the model was updated to excluse the variable of cost
cardiac_glm <- glm(cardiac ~ smoke + female + age, data = df_cohort, family="binomial")
summary (cardiac_glm)
